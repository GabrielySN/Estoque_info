...
CREATE TABLE `usuarios` (
  ...
  `tipo_usuario` enum('direcao','professor','aluno') NOT NULL,
  PRIMARY KEY (`email_escola`),
  KEY `idx_usuario_tipo` (`email_escola`, `tipo_usuario`)
...
CREATE TABLE `direcao` (
  ...
  `email_escola` varchar(70) NOT NULL,
  `tipo_usuario` enum('direcao') NOT NULL DEFAULT 'direcao',
  PRIMARY KEY (`id_direcao`),
  UNIQUE KEY `email_escola_UNIQUE` (`email_escola`),
  KEY `idx_direcao_tipo` (`email_escola`, `tipo_usuario`),
  CONSTRAINT `direcao_ibfk_1` FOREIGN KEY (`email_escola`, `tipo_usuario`) REFERENCES `usuarios` (`email_escola`, `tipo_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `professor` (
  `email_escola` varchar(70) NOT NULL,
  `tipo_usuario` enum('professor') NOT NULL DEFAULT 'professor',
  `nome_turma` varchar(10) DEFAULT NULL,
  `materia` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`email_escola`),
  KEY `nome_turma` (`nome_turma`),
  KEY `idx_professor_tipo` (`email_escola`, `tipo_usuario`),
  CONSTRAINT `professor_ibfk_1` FOREIGN KEY (`nome_turma`) REFERENCES `turma` (`nome_turma`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `professor_ibfk_2` FOREIGN KEY (`email_escola`, `tipo_usuario`) REFERENCES `usuarios` (`email_escola`, `tipo_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `aluno` (
  `email_escola` varchar(70) NOT NULL,
  `tipo_usuario` enum('aluno') NOT NULL DEFAULT 'aluno',
  `nome_turma` varchar(10) DEFAULT NULL,
  ...
  KEY `idx_aluno_tipo` (`email_escola`, `tipo_usuario`),
  ...
  CONSTRAINT `aluno_ibfk_3` FOREIGN KEY (`email_escola`, `tipo_usuario`) REFERENCES `usuarios` (`email_escola`, `tipo_usuario`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
